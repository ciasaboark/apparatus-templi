...
public class BlankSensorDriver extends SensorModule {
	 ...
	 * for the front tends to interact with the drivers.  The format
	...
	/*
	 * getSensorData() should return some XML data
	 * describing the current status of the requested sensor.
	 * It is up to the driver do decide whether to respond with
	 * cached data, or to query its remote module for an update.
	 * If the specified sensor does not exist, then return null.
	 */
	@Override
