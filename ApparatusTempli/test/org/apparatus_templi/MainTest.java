...
public class MainTest {
	...
	public void testMainWithNoArguments() throws IOException {
		...
		Process p = new ProcessBuilder("java", "-classpath",
				".:coordinator_eclipse_workspace/Coordinator/build/"
						+ ":coordinator_eclipse_workspace/Coordinator/build/org/apparatus_templi/"
						+ ":coordinator_eclipse_workspace/Coordinator/lib/*"
						+ ":coordinator_eclipse_workspace/Coordinator/lib/RXTX/macos/RXTXcomm.jar",
				"org.apparatus_templi.Coordinator", "--web_resourceFolder", "/").start();
